...
<head>
    ...
    <style>
        .para{
         height: 450px; 
        background: url(pics/hilthart-pedersen-93952.jpg);
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/wheat.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Wheat</h5>
                <h6>Rs.50/Kg</h6>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/rye.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Rye</h5>
                <h6>Rs.30/Kg</h6>
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/barley.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Barley</h5>
                <h6>Rs.70/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="barley 70 3">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/oats.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Oats</h5>
                <h6>Rs.80/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="oats 80 4">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/rice.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Rice</h5>
                <h6>Rs.60/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="rice 60 5">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/maize.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Maize</h5>
                <h6>Rs.40/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="maize 40 6">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/bazra.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Bajra</h5>
                <h6>Rs.40/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="bajra 40 7">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/jowar.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Jowar</h5>
                <h6>Rs.35/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="jowar 35 8">Buy Now</button>
            </div>
            </div>
