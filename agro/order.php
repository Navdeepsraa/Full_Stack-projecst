...
if(isset($_POST['pin']))
{
    ...
    $pin=$_POST['pin'];
    $add=$_POST['address'];
   // if($row['phone']==' ' || $row['address']==' ' || $row['pin']==' ' )
     $query1="UPDATE `register_agro` SET phone='$phone', pin='$pin', address='$add' WHERE id='$id'";
...
echo '<div class="container">
    <div  id="sign_in">
        ...
        <form method="post">
            ...
            <input type="text" class="form-control username" id="username1" placeholder="phone no" name="phone" value='.$row['phone'].'>
             <label>Pin Code</label>
            <input type="text" class="form-control" id="user" placeholder="pin code" name="pin" value='.$row['pin'].'>
            <label>Address</label>
            <textarea  class="form-control password" id="password1" name="address">'.$row['address'].'</textarea>        
