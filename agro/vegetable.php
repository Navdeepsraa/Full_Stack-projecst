  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <div class="container">
            <h2 id="grain_text">Vegetables</h2>
            <hr>
            
            <div class='box'>
                <div class="items">
                <img src="pics/peas.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Peas</h5>
                <h6>Rs.50/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success"onclick="on()" id="peas 50 1">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/bitter_gourd.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Bitter Gourd</h5>
                <h6>Rs.20/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="bitter_gourd 20 2">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/potato.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Potato</h5>
                <h6>Rs.20/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="potato 20 3">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/onion.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Onion</h5>
                <h6>Rs.20/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="onion 20 4">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/carrot.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Carrot</h5>
                <h6>Rs.30/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="carrot 30 5">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/cauliflower.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Cauliflower</h5>
                <h6>Rs.30/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="cauliflower 30 6">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
                <div class="items">
                <img src="pics/capsicum.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Capsicum</h5>
                <h6>Rs.60/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="capsicum 60 7">Buy Now</button>
            </div>
            </div>
            ...
            <div class='box'>
             <div class="items">
                <img src="pics/bottle_gourd.jpg" class="items">
            </div>
                <div class="desc">
                <h5>Bottle Gourd</h5>
                <h6>Rs.30/Kg</h6>
            ...
            <div class="desc">
                 <button type="button" class="btn btn-success" onclick="on()" id="bottle_gourd 30 8" name="bottle_gourd 30 8">Buy Now</button>
